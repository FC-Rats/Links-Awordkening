...
<body>
    ...
    <div><a href="index.php"><button class="btn rounded-5 bg-coffee m-5 px-4 text-white fs-5 beautiful-button" >&larr; Retour à l'accueil</button></a></div>
            ...
            <div class="col-md-6 d-flex justify-content-center">
                <form class="col-lg-8 bg-viridian py-4 px-3 px-md-5 rounded-3">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <button type="button" id="game" class="mt-3 rounded-5 bg-coffee text-light beautiful-button px-4 py-2">Lancer la partie</button>
                    </div>
                </form>
            </div>
        </div>
