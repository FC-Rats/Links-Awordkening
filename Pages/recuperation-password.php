...
<body>
    ...
    <form method="POST" action="../Includes/update-password.php">
        <input type="hidden" name="token" value="<?php htmlspecialchars($_GET['token']); ?>">
    ...
    <script src="../Assets/fonts/password-toggle.js"></script>
    <script src="../Assets/fonts/password-check.js"></script>
</body>
