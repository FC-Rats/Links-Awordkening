...
export const ContainerRules = () => {
    ...
    return (
        <>
            ...
            <ContainerRuleGifBox gifUrl={"/img/icons/words-connections.png"} altText={'carré'} colorGif={'var(--hunterGreen)'} title="Proposition de Mots" textRule={'Suggérez des mots liés sémantiquement et orthographiquement aux autres mots afin de former de nouveaux liens. Soyez original et explorez des associations surprenantes.'} leftOrRight={isSmallScreen ? "left" : "right"} />
            ...
            <ContainerRuleGifBox gifUrl={"/img/icons/multi.png"} altText={'carré'} colorGif={'var(--hunterGreen)'} title="Parties Multijoueurs" textRule={"Rejoignez des parties avec vos amis ou d'autres joueurs. Soyez compétitif pour gagner la partie ! Découvrez les stratégies de jeu des autres participants."} leftOrRight={isSmallScreen ? "left" : "right"} />
