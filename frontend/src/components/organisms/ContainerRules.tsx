...
export const ContainerRules = () => {
    return (
        <>
            ...
            <ContainerRuleGifBox gifUrl={"/img/icons/community.png"} altText={'carré'} colorGif={'var(--hunterGreen)'} title="Communauté " textRule={"Partagez vos meilleures chaînes de mots sur les réseaux sociaux.Echangez avec vos amis via les messages."} leftOrRight={"left"} />
